...
Ltac unfold_locally :=
  ...
  exists emp, heap_empty, heap_empty; repeat split; auto; intros h H0; inversion_star H h H;
...
Proof.
  ...
  destruct H. inversion_star H h P. clear H. destruct P2.
  inv H0. clear P3. red in H. rewrite heap_union_empty_r.
  exists x. exists h,heap_empty. repeat split; auto. intros h0 P3. inversion_star H h P.
  clear P3. inversion_star H h P. clear P4. eexists. exists h4.
...
Proof.
  ...
  exists (hheap_ctx h1), h1, heap_empty. repeat split; auto. red. intros. subst.
  inversion_star H h P. clear H0. red in P0. exists h0, h. subst. repeat split; auto.
